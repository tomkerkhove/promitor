...
- {{% tag fixed %}} Performance degradation caused by high CPU usage when Promitor-agent-scraper has to scrape large set of Azure targets ([#1834](https://github.com/tomkerkhove/promitor/pull/2050))
