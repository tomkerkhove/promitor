...
{
    [Category("Unit")]
    public class VirtualMachineScaleSetMetricsDeclarationValidationStepsTests : MetricsDeclarationValidationStepsTests
    {
        [Fact]
        public void VirtualMachineScaleSetMetricsDeclaration_DeclarationWithoutAzureMetricName_Fails()
        {
            // Arrange
        ...
        [InlineData(0)]
        [InlineData(10001)]
        public void VirtualMachineScaleSetMetricsDeclaration_DeclarationWithInvalidMetricLimit_Fails(int metricLimit)
        {
            // Arrange
            var rawDeclaration = MetricsDeclarationBuilder.WithMetadata()
                .WithVirtualMachineScaleSetMetric(azureMetricLimit: metricLimit)
                .Build(Mapper);
            var metricsDeclarationProvider = new MetricsDeclarationProviderStub(rawDeclaration, Mapper);
        ...
        [Fact]
        public void VirtualMachineScaleSetMetricsDeclaration_DeclarationWithoutResourceAndResourceDiscoveryGroupInfo_Fails()
        {
            // Arrange
            var rawMetricsDeclaration = MetricsDeclarationBuilder.WithMetadata()
                .WithVirtualMachineScaleSetMetric(omitResource: true)
                .Build(Mapper);
        ...
        [Fact]
        public void VirtualMachineScaleSetMetricsDeclaration_DeclarationWithoutResourceButWithResourceDiscoveryGroupInfo_Succeeds()
        {
            // Arrange
            var rawMetricsDeclaration = MetricsDeclarationBuilder.WithMetadata()
                .WithVirtualMachineScaleSetMetric(omitResource: true, resourceDiscoveryGroupName:"sample-collection")
                .Build(Mapper);
            var metricsDeclarationProvider = new MetricsDeclarationProviderStub(rawMetricsDeclaration, Mapper);
