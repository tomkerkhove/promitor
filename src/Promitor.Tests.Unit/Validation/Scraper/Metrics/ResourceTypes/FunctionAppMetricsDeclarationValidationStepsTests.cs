...
{
    [Category("Unit")]
    public class FunctionAppMetricsDeclarationValidationStepsTests : MetricsDeclarationValidationStepsTests
    {
        [Fact]
        public void FunctionAppMetricsDeclaration_DeclarationWithoutAzureMetricName_Fails()
        {
            // Arrange
        ...
        [InlineData(0)]
        [InlineData(10001)]
        public void FunctionAppMetricsDeclaration_DeclarationWithInvalidMetricLimit_Fails(int metricLimit)
        {
            // Arrange
            var rawDeclaration = MetricsDeclarationBuilder.WithMetadata()
                .WithFunctionAppMetric(azureMetricLimit: metricLimit)
                .Build(Mapper);
            var metricsDeclarationProvider = new MetricsDeclarationProviderStub(rawDeclaration, Mapper);
        ...
        [Fact]
        public void FunctionAppMetricsDeclaration_DeclarationWithoutResourceAndResourceDiscoveryGroupInfo_Fails()
        {
            // Arrange
            var rawMetricsDeclaration = MetricsDeclarationBuilder.WithMetadata()
                .WithFunctionAppMetric(omitResource: true)
                .Build(Mapper);
        ...
        [Fact]
        public void FunctionAppMetricsDeclaration_DeclarationWithoutResourceButWithResourceDiscoveryGroupInfo_Succeeds()
        {
            // Arrange
            var rawMetricsDeclaration = MetricsDeclarationBuilder.WithMetadata()
                .WithFunctionAppMetric(omitResource: true, resourceDiscoveryGroupName:"sample-collection")
                .Build(Mapper);
            var metricsDeclarationProvider = new MetricsDeclarationProviderStub(rawMetricsDeclaration, Mapper);
