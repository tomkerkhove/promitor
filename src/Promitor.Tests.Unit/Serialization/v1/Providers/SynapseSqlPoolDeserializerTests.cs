...
namespace Promitor.Tests.Unit.Serialization.v1.Providers
{
    ...
    public class SynapseSqlPoolDeserializerTests : ResourceDeserializerTest<SynapseSqlPoolDeserializer>
    {
        ...
        {
            const string expectedPoolName = "promitor-synapse-sql-pool";
            YamlAssert.PropertySet<SynapseSqlPoolResourceV1, AzureResourceDefinitionV1, string>(
                _deserializer,
        ...
        {
            YamlAssert.PropertyNull<SynapseSqlPoolResourceV1, AzureResourceDefinitionV1>(
                _deserializer,
        ...
        {
            return new SynapseSqlPoolDeserializer(NullLogger<SynapseSqlPoolDeserializer>.Instance);
        }
    }
}