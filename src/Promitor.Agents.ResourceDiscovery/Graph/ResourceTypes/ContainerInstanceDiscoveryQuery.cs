...
{
    public class ContainerInstanceDiscoveryQuery : ResourceDiscoveryQuery
    {
        public override string[] ResourceTypes => new[] { "microsoft.containerinstance/containergroups" };
