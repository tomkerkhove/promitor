        ...
        public IDeserializer<AzureResourceDefinitionV1> GetDeserializerFor(ResourceType resourceType)
        {
            switch (resourceType)
            {
                ...
                case ResourceType.CognitiveServicesAccounts:
                    var cognitiveServicesAccountsLogger = _loggerFactory.CreateLogger<CognitiveServicesAccountsDeserializer>();
                    return new CognitiveServicesAccountsDeserializer(cognitiveServicesAccountsLogger);
