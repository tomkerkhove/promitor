...
namespace Promitor.Core.Scraping.ResourceTypes
{
    internal class FunctionAppScraper : AppServiceScraper<FunctionAppResourceDefinition>
    {
        ...
        protected override string BuildResourceUriWithoutDeploymentSlot(string subscriptionId, ScrapeDefinition<AzureResourceDefinition> scrapeDefinition, FunctionAppResourceDefinition resource)
        {
