...
namespace Promitor.Core.Scraping.ResourceTypes
{
    internal class AppPlanScraper : AzureMonitorScraper<AppPlanResourceDefinition>
    {
        ...
        protected override string BuildResourceUri(string subscriptionId, ScrapeDefinition<AzureResourceDefinition> scrapeDefinition, AppPlanResourceDefinition resource)
        {
